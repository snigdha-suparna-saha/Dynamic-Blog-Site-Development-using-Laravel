...
@section('body')
    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-header bg-gradient-primary text-center text-white py-3 "> Edit Blog Form</div>
                <div class="card-body">
                    ...
                    <form action="{{route('blog.update', ['id' => $blog->id])}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <textarea type="text" value="{{$blog->title}}" name="title" class="form-control"></textarea>
                            </div>
                        </div>
                        <div class="row mb-3">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <label><input type="radio" {{$blog->status == 1 ? 'checked' : ''}} name="status" value="1" checked/> Published</label>
