                ...
                <div class="col-md-6">
                    <div class="post-entry text-center">
                        ...
                        <div class="post-meta align-items-center text-center">
                            <figure class="author-figure mb-0 me-3 d-inline-block"><img src="{{asset('/')}}website/images/person_1.jpg" alt="Image" class="img-fluid"></figure>
                        ...
                        <ul class="comment-list">
                            ...
                            <li class="comment">
                                ...
                                <ul class="children">
                                    <li class="comment">
                                        <div class="vcard">
                                            <img src="{{asset('/')}}website/images/person_3.jpg" alt="Image placeholder">
                                        </div>
                                        <div class="comment-body">
                                            <h3>Jean Doe</h3>
                                            <div class="meta">January 9, 2018 at 2:21pm</div>
                                        ...
                                        <ul class="children">
                                            <li class="comment">
                                                <div class="vcard">
                                                    <img src="{{asset('/')}}website/images/person_4.jpg" alt="Image placeholder">
                                                </div>
                                                <div class="comment-body">
                                                    <h3>Jean Doe</h3>
                                                    <div class="meta">January 9, 2018 at 2:21pm</div>
                                                ...
                                                <ul class="children">
                                                    <li class="comment">
                                                        <div class="vcard">
                                                            <img src="{{asset('/')}}website/images/person_5.jpg" alt="Image placeholder">
                                                        </div>
                                                        <div class="comment-body">
                                                            <h3>Jean Doe</h3>
                                                            <div class="meta">January 9, 2018 at 2:21pm</div>
